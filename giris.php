    ...
    <div id="icerik" class="container" align="center">
        <div align="center" class="row">
            ...
            <div id="content-col" style="color: white; " class="bg-dark ">
                <?php
                if ($_POST['kullanici_adi'] == 'G201210587@sakarya.edu.tr' && $_POST['sifre'] == 'G201210587') {
                    echo "<p>Kullanıcı adınız ve şifreniz doğru.</p> <p>Hoşgeldiniz 'G201210587'</p><p>Anasayfaya yönlendiriliyorsunuz.</p>";
